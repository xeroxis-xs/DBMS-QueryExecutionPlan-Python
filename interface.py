            ...
            dbc.Container([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Row([
                            ...
                            dbc.Col(
                                dbc.Input(id="dbname", placeholder="Enter database name", type="text", value="postgres"),
                                width=9,
                            )
                        ], className="mb-3"),
                        dbc.Row([
                        ...
                        dbc.Button(["Connect", html.I(className="bi bi-database-fill-lock ms-2")], id="connect-button", color="primary", className="my-3"),
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Button(["Execute", html.I(className="bi bi-play-fill ms-2")], id="execute-button", color="primary", className="my-3", disabled=True),
                        dbc.Alert(
                            id="query-status",
                            color="info",
                            is_open=False,
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Button(["Get QEP", html.I(className="bi bi-filetype-json ms-2")], id="qep-button", color="primary", className="my-3", disabled=True),
                            ...
                            dbc.Col(
                                dcc.Loading(
                                    ...
                                    children=[
                                        ...
                                        fmc.FefferyMarkdown(id="qep-output", codeTheme="atom-dark"),
                                    ]
                                ),
                    ...
                    dbc.Col([
                        ...
                        dbc.Button(["Show QEP Graph", html.I(className="bi bi-diagram-3-fill ms-2")], id="show-qep-graph", color="primary", className="my-3", disabled=True),
    ...
    def set_callbacks(self):
        ...
        def connect_to_db(n_clicks, host, port, dbname, user, password):
            ...
            try:
                ...
                return ([html.I(className="bi bi-check-circle-fill me-2"), "Connected successfully! "],
                        "success", True, table_children, f"Time taken: {round(time_taken * 1000)} milliseconds", False, False)
            except psycopg2.OperationalError as e:
                print(f"Connection failed: {e}")
                return ([html.I(className="bi bi-x-octagon-fill me-2"), "Connection failed:", fmc.FefferyMarkdown(markdownStr=f"```sh\n{e}\n```", codeTheme="atom-dark", className="mt-3")],
        ...
        def execute_query(n_clicks, query):
            ...
            try:
                ...
                if result:
                    ...
                    return [html.I(className="bi bi-check-circle-fill me-2"), "Query executed successfully!"], "success", True, table, f"Time taken: {round(time_taken * 1000)} milliseconds", f"Rows returned: {rows}"
                else:
                    return [html.I(className="bi bi-check-circle-fill me-2"), "Query executed successfully!"], "success", True, html.P("Query executed successfully!"), f"Time taken: {round(time_taken * 1000)} milliseconds", "No rows returned"
        ...
        def get_qep(n_clicks, query):
            ...
            try:
                ...
                return [html.I(className="bi bi-check-circle-fill me-2"), "Query execution plan generated successfully!"], "success", True, f"```json\n{self.qep}\n```", f"Time taken: {round(time_taken * 1000)} milliseconds", False
            except psycopg2.Error as e:
                return [html.I(className="bi bi-x-octagon-fill me-2"), "Error generating query execution plan:", fmc.FefferyMarkdown(markdownStr=f"```sh\n{str(e)}\n```", codeTheme="atom-dark", className="mt-3")], "danger", True, "", "", True
        ...
        def show_qep_graph(n_clicks):
            ...
            if self.qep:
                ...
                # graph.print_graph()
                graph.build_graph()
                return dcc.Graph(figure=graph.plot_graph()), [html.I(className="bi bi-check-circle-fill me-2"), "QEP Graph generated successfully!"], "success", True
            else:
                return None, [html.I(className="bi bi-x-octagon-fill me-2"), "No QEP available to generate graph"], "danger", True
